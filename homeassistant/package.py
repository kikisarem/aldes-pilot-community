...
names=['app.py','pico.py','index.html','manifest.json','reader.py','raw_audit.py','report21.py','report_clock.py','readback.py','collector.py','supervisor.py','recovery.py','mqtt_bridge.py','requirements.txt','icon-192.png','icon-512.png']
