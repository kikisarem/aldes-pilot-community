...
Le code et la documentation originaux sont proposés sous licence Apache-2.0, disponible dans LICENSE. Les composants tiers conservent leurs propres licences. Cette licence ne donne aucun droit sur les logiciels propriétaires ou les marques de tiers ; sa concession de brevet est limitée aux droits des contributeurs définis dans son article 3. Les précautions de ce document complètent les informations du projet sans ajouter de restrictions à la licence ni modifier ses termes.
